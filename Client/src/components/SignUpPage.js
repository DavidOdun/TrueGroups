...
class SignUpPage extends Component {
    ...
    validateForm = () => {
        ...
        if (email_error || username_error || password_error || firstname_error || lastname_error || preferredname_error || userrole_error || institution_error)
        {
            this.setState(
                {
      ...
      return (
            <div>
                ...
                <Form>
                    ...
                    <div style={{fontSize: 12, color: "red"}}>{this.state.username_error}</div>
                    <FormGroup>
                    ...
                    <div style={{fontSize: 12, color: "red"}}>{this.state.firstname_error}</div>
                    <FormGroup>
                    ...
                    <div style={{fontSize: 12, color: "red"}}>{this.state.lastname_error}</div>
                    <FormGroup>
                    ...
                    <div style={{fontSize: 12, color: "red"}}>{this.state.preferredname_error}</div>
                    <FormGroup>
                    ...
                    <div style={{fontSize: 12, color: "red"}}>{this.state.userrole_error}</div> 
                    <FormGroup>
                    ...
                    <div style={{fontSize: 12, color: "red"}}>{this.state.institution_error}</div>      
                    <FormGroup>
                    ...
                    <Button color="primary" size="lg" onClick={() => this.handleSubmit()} block>Submit</Button>
                </Form>
                </div>
            </div>
      );
